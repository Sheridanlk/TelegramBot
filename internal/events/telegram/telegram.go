...
func New(tgclient *tgclient.Client, rconclient *rconclient.Client, rconpoller *rconpoller.Poller, storage storage.Storage) *Processor {
	return &Processor{
		tg:         tgclient,
		rcon:       rconclient,
		rconpoller: rconpoller,
		storage:    storage,
	}
}
